...
public class DSSGrowTemplate {
	...
	;
		...
		try {
			...
			if (CommonUtil.isValidObject(filetype) && filetype.equalsIgnoreCase("pnpGrow")) {
			String eNB4G = "";
			String NEID = "";
			String gNBID="";
			...
			growFileName = "pnpGrow" + enbName + dateString + ".csv";
			...
			System.out.println(NeVersion);
//22A
//"PRACH Coverage Extension B6G TDD" added
